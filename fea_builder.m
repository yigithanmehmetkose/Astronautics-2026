...
model.component('comp1').material('mat4').label('panels');
model.component('comp1').material('mat4').selection.set([1 3 7 8 9 10 11 30]);
model.component('comp1').material('mat4').propertyGroup('def').set('density', {'1600'});
model.component('comp1').material('mat4').propertyGroup('def').set('thermalconductivity', {'130'});
model.component('comp1').material('mat4').propertyGroup('def').set('heatcapacity', {'900'});

model.component('comp1').material.create('mat5', 'Common');
model.component('comp1').material('mat5').propertyGroup('def').set('density', {'600'});
model.component('comp1').material('mat5').propertyGroup('def').set('heatcapacity', {'1500'});
model.component('comp1').material('mat5').label('MLI x');
model.component('comp1').material('mat5').selection.set([4 6]);
model.component('comp1').material('mat5').propertyGroup('def').set('thermalconductivity', {'5' '5' '1e-5'});

model.component('comp1').material.duplicate('mat6', 'mat5');
model.component('comp1').material('mat6').selection.set([31]);
model.component('comp1').material('mat6').label('MLI y');
model.component('comp1').material('mat6').propertyGroup('def').set('thermalconductivity', {'1e-5' '5' '5'});

model.component('comp1').material.duplicate('mat7', 'mat6');
model.component('comp1').material('mat7').label('MLI z');
model.component('comp1').material('mat7').selection.set([5 12]);
model.component('comp1').material('mat7').propertyGroup('def').set('thermalconductivity', {'5' '1e-5' '5'});

model.component('comp1').material.duplicate('mat8', 'mat4');
model.component('comp1').material('mat8').label('BMSP');
model.component('comp1').material('mat8').selection.set([2]);
model.component('comp1').material('mat8').propertyGroup('def').set('thermalconductivity', {'2e-8' '130' '130'});
...
for i=1:N_payload*Period
    for j=1:Period_payload
        ...
        if j <= t_payload
            model.func('int1').setIndex('table', 100, t-1, 1);
        else
...
model.component('comp1').physics('ht').feature('hs8').set('P0', '(110+int1(t))*(1/0.9-1)');
...
model.component('comp1').physics('rad').feature('dsurf1').set('Tamb', '4[K]');
...
model.component('comp1').physics('rad').feature('dsurf2').set('Tamb', '4[K]');
...
model.component('comp1').physics('rad').feature('dsurf3').set('Tamb', '4[K]');
...
model.component('comp1').physics('rad').feature('dsurf4').set('epsilon_rad', 0.89);
model.component('comp1').physics('rad').feature('dsurf4').set('Tamb', '4[K]');
...
model.component('comp1').physics('rad').feature('dsurf5').set('epsilon_rad', 0.2);
model.component('comp1').physics('rad').feature('dsurf5').set('Tamb', '4[K]');
...
model.component('comp1').physics('rad').feature('dsurf6').set('epsilon_rad', 0.82);
model.component('comp1').physics('rad').feature('dsurf6').label('solar panels');
model.component('comp1').physics('rad').feature('dsurf6').set('Tamb', '4[K]');
...
model.func('int2').setIndex('table', 120, 0, 1);
model.func('int2').setIndex('table', 60, 1, 0);
model.func('int2').setIndex('table', 0, 1, 1);
...
model.func('int3').setIndex('table', 120, 0, 1);
model.func('int3').setIndex('table', 60, 1, 0);
model.func('int3').setIndex('table', 0, 1, 1);

model.func.create('int4', 'Interpolation');
model.func('int4').label('PlusY_rad');
model.func.move('int4', 3);
model.func('int4').setIndex('table', 0, 0, 0);
model.func('int4').setIndex('table', 120, 0, 1);
model.func('int4').setIndex('table', 60, 1, 0);
model.func('int4').setIndex('table', 0, 1, 1);
...
model.func('int5').setIndex('table', 0, 0, 0);
model.func('int5').setIndex('table', 120, 0, 1);
model.func('int5').setIndex('table', 60, 1, 0);
model.func('int5').setIndex('table', 0, 1, 1);
...
model.func('int6').setIndex('table', 0, 0, 0);
model.func('int6').setIndex('table', 120, 0, 1);
model.func('int6').setIndex('table', 60, 1, 0);
model.func('int6').setIndex('table', 0, 1, 1);
...
model.func('int7').setIndex('table', 120, 0, 1);
model.func('int7').setIndex('table', 60, 1, 0);
model.func('int7').setIndex('table', 0, 1, 1);
...
model.func('int8').setIndex('table', 0, 0, 0);
model.func('int8').setIndex('table', 120, 0, 1);
model.func('int8').setIndex('table', 60, 1, 0);
model.func('int8').setIndex('table', 0, 1, 1);
...
model.func('int9').setIndex('table', 0, 0, 0);
model.func('int9').setIndex('table', 120, 0, 1);
model.func('int9').setIndex('table', 60, 1, 0);
model.func('int9').setIndex('table', 0, 1, 1);
...
model.func('int10').setIndex('table', 0, 0, 0);
model.func('int10').setIndex('table', 120, 0, 1);
model.func('int10').setIndex('table', 60, 1, 0);
model.func('int10').setIndex('table', 0, 1, 1);
...
model.func('int11').setIndex('table', 0, 0, 0);
model.func('int11').setIndex('table', 120, 0, 1);
model.func('int11').setIndex('table', 60, 1, 0);
model.func('int11').setIndex('table', 0, 1, 1);
model.func('int11').setIndex('fununit', 'W/m^2', 0);
model.func('int11').setIndex('argunit', 's', 0);

model.func.create('int12', 'Interpolation');
model.func('int12').label('MinusY_SP');
model.func.move('int12', 11);
model.func('int12').setIndex('table', 0, 0, 0);
model.func('int12').setIndex('table', 120, 0, 1);
model.func('int12').setIndex('table', 60, 1, 0);
model.func('int12').setIndex('table', 0, 1, 1);
model.func('int12').setIndex('fununit', 'W/m^2', 0);
model.func('int12').setIndex('argunit', 's', 0);

model.func.create('int13', 'Interpolation');
model.func('int13').label('Solar_Flux');
model.func.move('int13', 12);
model.func('int13').setIndex('table', 0, 0, 0);
model.func('int13').setIndex('table', 120, 0, 1);
model.func('int13').setIndex('table', 60, 1, 0);
model.func('int13').setIndex('table', 0, 1, 1);
model.func('int13').setIndex('fununit', 'W/m^2', 0);
model.func('int13').setIndex('argunit', 's', 0);
...
model.component('comp1').physics('ht').feature('hf4').set('q0_input', 'int12(t)');

model.component('comp1').physics('ht').create('hf5', 'HeatFluxBoundary', 2);
model.component('comp1').physics('ht').feature('hf5').selection.set([18]);
...
model.func('extm1').setIndex('funcs', 'P,T,S,i', 0, 1);
...
model.component('comp1').physics('ht').feature('hs9').set('P0', 'battery_heat_dissipation((110+int1(t))*(1/0.9),bnd1,int13(t),0)');
...
model.component('comp1').probe('bnd2').selection.set([100]);
model.component('comp1').probe('bnd2').label('propulsion');

model.component('comp1').physics('ht').create('hs10', 'HeatSource', 3);
model.component('comp1').physics('ht').feature('hs10').label('Propulsion Heater');
model.component('comp1').physics('ht').feature('hs10').selection.set([19]);
model.component('comp1').physics('ht').feature('hs10').set('heatSourceType', 'HeatRate');
model.component('comp1').physics('ht').feature('hs10').set('P0', 'on_off_heater(bnd2)');

model.component('comp1').probe.duplicate('bnd3', 'bnd2');
model.component('comp1').probe('bnd3').label('battery');
model.component('comp1').probe('bnd3').selection.set([149]);

model.component('comp1').physics('ht').create('hs11', 'HeatSource', 3);
model.component('comp1').physics('ht').feature('hs11').label('Battery Heater');
model.component('comp1').physics('ht').feature('hs11').selection.set([27]);
model.component('comp1').physics('ht').feature('hs11').set('heatSourceType', 'HeatRate');
model.component('comp1').physics('ht').feature('hs11').set('P0', 'on_off_heater(bnd3)');
...
model.component('comp1').probe('var1').set('expr', 'battery_heat_dissipation((120+int1(t))*(1/0.9),bnd1,int13(t))');
...
model.component('comp1').probe('var2').set('expr', 'on_off_heater(bnd2)+on_off_heater(bnd3)');
...
model.study('std1').feature('time').set('tlist', 'range(0,1200,68400)');
...
model.sol('sol1').feature('t1').set('tlist', 'range(0,600,68400)');
model.sol('sol1').feature('t1').set('plot', 'off');
model.sol('sol1').feature('t1').set('plotgroup', 'Default');
model.sol('sol1').feature('t1').set('plotfreq', 'tout');
model.sol('sol1').feature('t1').set('probesel', 'all');
model.sol('sol1').feature('t1').set('probes', {'dom1' 'bnd1' 'bnd3' 'bnd2'});
